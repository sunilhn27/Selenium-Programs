...
public class pomelements {
	...
	public void passingdata(String fname, String lname, String email, String pass, String phno) throws Exception {
		...
		WebElement capcha = d.findElement(By.xpath("captchaView"));
		String b = capcha.getText();
		d.findElement(By.xpath("captcha")).sendKeys(b);
